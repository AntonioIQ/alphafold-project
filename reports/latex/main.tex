...
\begin{titlepage}
    ...
    \vspace{0.5cm}
    {\large Longitud de cadena $\cdot$ Amino\'acidos $\cdot$ Grupos funcionales $\cdot$ CHONSP\par}
    \vspace{2cm}
    {\Large\itshape Antonio Tapia\par}
    \vspace{0.5cm}
    {\large Maestr\'ia en Ciencia de Datos --- ITAM\par}
    \vspace{0.5cm}
    {\large \today\par}
    \vfill
    {\large Ciencia de Datos Computacional\par}
\end{titlepage}
